const Contact = () => (
  <section  id="contact" className="bg-[#1a1d20] p-8 rounded-xl border border-gray-800">
    ...
    <form className="space-y-4">
      ...
      <button className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 rounded-md uppercase tracking-widest text-xs transition-colors">
        Send Message
      </button>
    </form>
