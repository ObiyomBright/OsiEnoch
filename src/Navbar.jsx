...
const Navbar = () => {
    ...
    const handleNavClick = (e, link) => {
        ...
        if (target) {
            ...
            }, 300); // wait for mobile menu to close first
        }
    };
    ...
    return (
        <nav className="fixed top-0 w-full z-50 bg-[#0f1113]/80 backdrop-blur-md border-b border-gray-800">
            ...
            {/* Mobile Menu Overlay */}
            <div
                className={`md:hidden overflow-hidden transition-all duration-300 ease-in-out bg-[#0f1113]/95 border-b border-gray-800 ${isOpen ? 'max-h-screen opacity-100' : 'max-h-0 opacity-0'
                    }`}
            >
